...
window.files['contrib/frostlands/text.json'] = ` 
{
	"info" : {
		"welcome2" :
	...
	"npc" : {
		...
		"fire-B" :
		"I heard if you walk to the Right of the first Forest level, there's some ruins. I might check it out one day.",
		"mrq" :
		"Hai! I'm Marqies. Welcome to the Feather Shrine! Something Cool is up ahead",
		"mark" :
		"...",
		"Gold" :
		"Hey there buddy, check the game's mod folder. there's a little suprise for you",
		"flame" :
		"One day I will get a game of my own.. just you wait!",
		"pix" :
		"Hi, im from an old scratch game made by the creator this mod. hope they update the game sometime! (dev note: I won't update it)",
		"ninja" :
