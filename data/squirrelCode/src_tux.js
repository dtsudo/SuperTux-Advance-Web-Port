...
Tux =  function ( ) { var returnVal = { constructor: function(){} } ;  returnVal = PhysAct ( 'DO_NOT_CALL_CONSTRUCTOR' ) ; var baseMethods = { ... returnVal }; var baseConstructor = returnVal.constructor;  returnVal . canJump = 16 ; 
 ...
 returnVal . anDive =  [ 24.0 , 25.0 , "dive" ]  ; 
 returnVal . anSlide =  [ 26.0 , 29.0 , "slide" ]  ; 
 returnVal . anHurt =  [ 30.0 , 31.0 , "hurt" ]  ; 
 ...
 returnVal . anWall =  [ 48.0 , 49.0 , "wall" ]  ; 
 returnVal . anFallW =  [ 48.0 , 48.0 , "wall" ]  ; 
 returnVal . anSwimF =  [ 52.0 , 55.0 , "swim" ]  ; 
 returnVal . anSwimUF =  [ 56.0 , 59.0 , "swim" ]  ; 
 returnVal . anSwimDF =  [ 60.0 , 63.0 , "swim" ]  ; 
 returnVal . anSwimU =  [ 64.0 , 67.0 , "swim" ]  ; 
 returnVal . anSwimD =  [ 68.0 , 71.0 , "swim" ]  ; 
...
anim = anSkid ; 
 ...
 frame = anim [ 0 ]  ; 
  ...
  break ;  case anPush :  break ;  case anJumpU :  if ( frame < anim [ 0 ]  + 1 ) frame += 0.1 ; 
...
frame = anim [ 0 ]  ; 
 break ;  case anSwimUF :  case anSwimU :  if ( abs ( hspeed )  > 1.5 ) anim = anSlide ; 
...
firetime = 60 ; 
 if ( anim == anCrawl ) c . y += 8 ; 
  ...
  var c = actor [ newActor ( Iceball , x + fx , y - 4 )  ]  ;
  if (  ! flip ) c . hspeed = 5 ; 
...
frame = anim [ 0 ]  ; 
 ...
 if ( anim != anHurt )  { 
  ...
  var c = actor [ newActor ( Fireball , x + fx , y )  ]  ;
  if (  ! flip ) c . hspeed = 3 ; 
...
frame = anim [ 0 ]  ; 
 ...
 return ; 
  ...
  if (  ! hidden )  { 
  switch ( game . weapon )  {  case 0 : sprite = sprTux ; 
 break ;  case 1 : sprite = sprTuxFire ; 
 break ;  case 2 : sprite = sprTuxIce ; 
 break ;  case 3 : sprite = sprTuxAir ; 
 break ;  case 4 : sprite = sprTuxEarth ; 
...
timer --  ; 
 ...
 break ;  case 4 : drawSprite ( sprTuxEarth , wrap ( getFrames (  )  / 15 , 50 , 51 )  , floor ( x - camx )  , floor ( y - camy )  )  ; 
