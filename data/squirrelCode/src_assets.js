...
window.superTuxAdvanceWebVersion.squirrelFiles['src/assets.nut'] = function () { 
...
sndSurgeCharge =  [ loadSound ( "res/snd/surge-charge-0.ogg" )  , loadSound ( "res/snd/surge-charge-1.ogg" )  , loadSound ( "res/snd/surge-charge-2.ogg" )  , loadSound ( "res/snd/surge-charge-3.ogg" )  , loadSound ( "res/snd/surge-charge-4.ogg" )  , loadSound ( "res/snd/surge-charge-5.ogg" )  , loadSound ( "res/snd/surge-charge-6.ogg" )  , loadSound ( "res/snd/surge-charge-7.ogg" )  , loadSound ( "res/snd/surge-charge-8.ogg" )  , loadSound ( "res/snd/surge-charge-9.ogg" )  , loadSound ( "res/snd/surge-charge-10.ogg" )  ]  ; 
...
sndPing =  [ loadSound ( "res/snd/ping-0.ogg" )  , loadSound ( "res/snd/ping-1.ogg" )  , loadSound ( "res/snd/ping-2.ogg" )  , loadSound ( "res/snd/ping-3.ogg" )  , loadSound ( "res/snd/ping-4.ogg" )  , loadSound ( "res/snd/ping-5.ogg" )  , loadSound ( "res/snd/ping-6.ogg" )  , loadSound ( "res/snd/ping-7.ogg" )  ]  ; 
...
songPlay =  function ( song ) {  if ( song == 0 )  { 
 songStop (  )  ; 
 return ; 
  } 
...
songStop =  function (  ) { stopMusic (  )  ; 
gvMusicName = 0 ; 
gvLastSong = 0 ; 
 }  ; 
gfxReset =  function (  ) { sprTux = defTux ; 
...
gfxEnemySnow =  function (  ) { sprDeathcap = sprMrSnowball ; 
...
gfxEnemyForest =  function (  ) { sprMrIceguy = sprMrTurtle ; 
