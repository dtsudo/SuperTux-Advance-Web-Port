...
window.superTuxAdvanceWebVersion.squirrelFiles['src/camera.nut'] = function () { 
...
gvSplitScreen = false ; 
gvSwapScreen = false ; 
updateCamera =  function (  ) {  if (  squirrelTypeOf ( gvMap )  != "Tilemap" )  return ; 
 ...
 gvSplitScreen = true ; 
  ...
  if ( gvPlayer && gvPlayer2 && inDistance2 ( gvPlayer . x , gvPlayer . y , gvPlayer2 . x , gvPlayer2 . y , 160 )  &&  ( gvCamTarget == gvPlayer && gvCamTarget2 == gvPlayer2 || gvCamTarget == gvCamTarget2 )  ) gvSplitScreen = false ; 
...
py =  ( gvCamTarget . y )  -  ( gvScreenH / 2 )  + ly ; 
  ...
  if ( config . lookAhead ) px =  (  (  ( gvPlayer . x + gvPlayer2 . x )  / 2.0 )  +  (  (  ( gvPlayer . x - gvPlayer . xprev )  +  ( gvPlayer2 . x - gvPlayer2 . xprev )  )  * 16 )  )  -  ( gvScreenW / 2 )  + lx ; 
 
  else px =  (  (  ( gvPlayer . x + gvPlayer2 . x )  / 2.0 )  )  -  ( gvScreenW / 2 )  + lx ; 
...
py = camy0 ; 
  ...
  { 
  if ( gvPlayer && gvPlayer2 ) camx0 +=  ( px - camx0 )  /  ( config . lookAhead ? 16 : 8 )  ; 
 
  else camx0 +=  ( px - camx0 )  /  ( config . lookAhead ? 24 : 8 )  ; 
...
py =  ( gvCamTarget . y +  ( gvPlayer . y - gvPlayer . yprev )  * 8 )  -  ( gvScreenH / 2 )  + ly ; 
  ...
  var pw = max ( gvScreenW , 320 )  ;
  var ph = max ( gvScreenH , 240 )  ;
  var ptx =  ( gvCamTarget . x )  -  ( gvScreenW / 4 )  ;
  var pty =  ( gvCamTarget . y )  -  ( gvScreenH / 2 )  ;
...
py =  ( gvPlayer2 . y +  ( gvPlayer2 . y - gvPlayer2 . yprev )  * 8 )  -  ( gvScreenH / 2 )  + ly ; 
  ...
  var pw = max ( gvScreenW , 320 )  ;
  var ph = max ( gvScreenH , 240 )  ;
  var ptx =  ( gvCamTarget2 . x )  -  ( gvScreenW / 4 )  ;
  var pty =  ( gvCamTarget2 . y )  -  ( gvScreenH / 2 )  ;
...
CameraGrabber =  ((function(){ let squirrelClassFunction; squirrelClassFunction = function ( ) { var returnVal = { constructor: function(){} } ;  returnVal = Actor ( 'DO_NOT_CALL_CONSTRUCTOR' ) ; var baseMethods = { ... returnVal }; var baseConstructor = returnVal.constructor;  for (var baseProperty in returnVal) { 
     if (returnVal.hasOwnProperty(baseProperty) && (typeof returnVal[baseProperty]) !== 'function' && squirrelClassFunction[baseProperty] === undefined) 
         squirrelClassFunction[baseProperty] = returnVal[baseProperty]; 
 } 
 returnVal . w = 0 ; 
 returnVal . h = 0 ; 
 returnVal . lock = false ; 
...
lock =  ( _arr != null )  ; 
  ...
  if (  ( gvPlayer && gvPlayer . x >= x - w && gvPlayer . y >= y - h && gvPlayer . x <= x + w && gvPlayer . y <= y + h )  ||  ( gvPlayer2 && gvPlayer2 . x >= x - w && gvPlayer2 . y >= y - h && gvPlayer2 . x <= x + w && gvPlayer2 . y <= y + h )  )  { 
 gvCamTarget = this ; 
gvCamTarget2 = this ; 
 } 
  ...
  if ( gvPlayer && gvPlayer . x >= x - w && gvPlayer . y >= y - h && gvPlayer . x <= x + w && gvPlayer . y <= y + h ) gvCamTarget = this ; 
 
  if ( gvPlayer2 && gvPlayer2 . x >= x - w && gvPlayer2 . y >= y - h && gvPlayer2 . x <= x + w && gvPlayer2 . y <= y + h ) gvCamTarget2 = this ; 
...
camy1 = y - gvScreenH / 2 ; 
  ...
  } ;  returnVal . _typeof = function (  ) {  return "CameraGrabber" ;
  } ; 
 } 
 returnVal.constructor(...arguments); returnVal.SQUIRREL_CLASS = squirrelClassFunction; return returnVal ;  };  squirrelClassFunction . w = 0 ; 
 squirrelClassFunction . h = 0 ; 
 squirrelClassFunction . lock = false ; 
...
CameraBlock =  ((function(){ let squirrelClassFunction; squirrelClassFunction = function ( ) { var returnVal = { constructor: function(){} } ;  returnVal = PhysAct ( 'DO_NOT_CALL_CONSTRUCTOR' ) ; var baseMethods = { ... returnVal }; var baseConstructor = returnVal.constructor;  for (var baseProperty in returnVal) { 
     if (returnVal.hasOwnProperty(baseProperty) && (typeof returnVal[baseProperty]) !== 'function' && squirrelClassFunction[baseProperty] === undefined) 
         squirrelClassFunction[baseProperty] = returnVal[baseProperty]; 
 } 
 returnVal . w = 0 ; 
