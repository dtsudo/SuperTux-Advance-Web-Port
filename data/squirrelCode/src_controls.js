...
window.superTuxAdvanceWebVersion.squirrelFiles['src/controls.nut'] = function () { 


gvPadTypes =  [ "XBox" , "DInput" , "Generic" ]  ; 
gvAutoCon = false ; 
autocon =  { a :  { up : false , down : false , left : false , right : false , jump : false , shoot : false , spec1 : false , spec2 : false , swap : false , accept : false , peekLeft : false , peekRight : false , peekUp : false , downPeek : false , wasUp : false , wasDown : false , wasLeft : false , wasRight : false , wasJump : false , wasShoot : false , wasSpec1 : false , wasSpec2 : false , wasSwap : false , wasAccept : false , wasPeekLeft : false , wasPeekRight : false , wasPeekUp : false , wasDownPeek : false , pressUp : false , pressDown : false , pressLeft : false , pressRight : false , pressJump : false , pressShoot : false , pressSpec1 : false , pressSpec2 : false , pressSwap : false , pressAccept : false , pressPeekLeft : false , pressPeekRight : false , pressPeekUp : false , pressDownPeek : false , releaseUp : false , releaseDown : false , releaseLeft : false , releaseRight : false , releaseJump : false , releaseShoot : false , releaseSpec1 : false , releaseSpec2 : false , releaseSwap : false , releaseAccept : false , releasePeekLeft : false , releasePeekRight : false , releasePeekUp : false , releaseDownPeek : false }  , b :  { up : false , down : false , left : false , right : false , jump : false , shoot : false , spec1 : false , spec2 : false , swap : false , accept : false , peekLeft : false , peekRight : false , peekUp : false , downPeek : false , wasUp : false , wasDown : false , wasLeft : false , wasRight : false , wasJump : false , wasShoot : false , wasSpec1 : false , wasSpec2 : false , wasSwap : false , wasAccept : false , wasPeekLeft : false , wasPeekRight : false , wasPeekUp : false , wasDownPeek : false , pressUp : false , pressDown : false , pressLeft : false , pressRight : false , pressJump : false , pressShoot : false , pressSpec1 : false , pressSpec2 : false , pressSwap : false , pressAccept : false , pressPeekLeft : false , pressPeekRight : false , pressPeekUp : false , pressDownPeek : false , releaseUp : false , releaseDown : false , releaseLeft : false , releaseRight : false , releaseJump : false , releaseShoot : false , releaseSpec1 : false , releaseSpec2 : false , releaseSwap : false , releaseAccept : false , releasePeekLeft : false , releasePeekRight : false , releasePeekUp : false , releaseDownPeek : false }  }  ; 
updateAutocon =  function (  ) { autocon . a . pressLeft = autocon . a . left &&  ! autocon . a . wasLeft ; 
...
defAutocon =  window.clone(  ( autocon ) )  ; 
netconState =  { up : false , down : false , left : false , right : false , jump : false , shoot : false , spec1 : false , spec2 : false , swapItem : false , wasUp : false , wasDown : false , wasLeft : false , wasRight : false , wasJump : false , wasShoot : false , wasSpec1 : false , wasSpec2 : false , wasSwapItem : false }  ; 
getcon =  function ( control , state , useauto = false , player = 0 ) {  var keyfunc = 0 ;
  var joyfunc = 0 ;
  var hatfunc = 0 ;
  var joy = null ;
  var autonum = null ;
 ...
 autonum = autocon . a ; 
  ...
  if ( player == 2 )  { 
 joy =  window.clone(  ( config . joy2 ) )  ; 
autonum = autocon . b ; 
 } 
  
  switch ( state )  {  case "press" : keyfunc = keyPress ; 
joyfunc = joyButtonPress ; 
hatfunc = joyHatPress ; 
 break ;  case "release" : keyfunc = keyRelease ; 
joyfunc = joyButtonRelease ; 
hatfunc = joyHatRelease ; 
 break ;  case "hold" : keyfunc = keyDown ; 
joyfunc = joyButtonDown ; 
hatfunc = joyHatDown ; 
 break ;  default :  return false ;
  break ;  }  switch ( control )  {  case "up" :  if ( player == 2 && gvNetPlay )  { 
  ...
  if ( state == "hold" )  return autonum . up ;
  
  if ( state == "press" )  return autonum . pressUp ;
  
  if ( state == "release" )  return  ! autonum . releaseUp ;
 ...
 i < joyCount (  )  ; i ++  )  { 
  ...
  break ;  case "down" :  if ( player == 2 && gvNetPlay )  { 
  ...
  if ( state == "hold" )  return autonum . down ;
  
  if ( state == "press" )  return autonum . pressDown ;
  
  if ( state == "release" )  return  ! autonum . releaseDown ;
  ...
  if ( player == 2 || gvNumPlayers == 1 || joyCount (  )  > 1 )  { 
  if ( hatfunc ( joy . index , js_down )  ||  ( state == "hold" && joyY ( joy . index )  <  - deadzone && config . stickactive )  )  return true ;
  ...
  for (  var i = 0 ;
 i < joyCount (  )  ; i ++  )  { 
  if ( hatfunc ( i , js_down )  ||  ( state == "hold" && joyY ( i )  <  - deadzone && config . stickactive )  )  return true ;
  ...
  break ;  case "left" :  if ( player == 2 && gvNetPlay )  { 
  if ( state == "hold" && netconState . left )  return true ;
  
  if ( state == "press" && netconState . left &&  ! netconState . wasLeft )  return true ;
  
  if ( state == "release" &&  ! netconState . left && netconState . wasLeft )  return true ;
  
  } 
  
  else  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . left ;
  
  if ( state == "press" )  return autonum . pressLeft ;
  
  if ( state == "release" )  return  ! autonum . releaseLeft ;
  ...
  if ( state == "press" && joyAxisPress ( joy . index , 0 , deadzone )  ==  - 1 && config . stickactive )  return true ;
  
  if ( state == "release" && joyAxisRelease ( joy . index , 0 , deadzone )  ==  - 1 && config . stickactive )  return true ;
 ...
 i < joyCount (  )  ; i ++  )  { 
  ...
  if ( state == "press" && joyAxisPress ( i , 0 , deadzone )  ==  - 1 && config . stickactive )  return true ;
  
  if ( state == "release" && joyAxisRelease ( i , 0 , deadzone )  ==  - 1 && config . stickactive )  return true ;
  ...
  break ;  case "right" :  if ( player == 2 && gvNetPlay )  { 
  if ( state == "hold" && netconState . right )  return true ;
  
  if ( state == "press" && netconState . right &&  ! netconState . wasRight )  return true ;
  
  if ( state == "release" &&  ! netconState . right && netconState . wasRight )  return true ;
  
  } 
  
  else  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . right ;
  
  if ( state == "press" )  return autonum . pressRight ;
  
  if ( state == "release" )  return  ! autonum . releaseRight ;
 ...
 i < joyCount (  )  ; i ++  )  { 
  ...
  break ;  case "jump" :  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . jump ;
  
  if ( state == "press" )  return autonum . pressJump ;
  
  if ( state == "release" )  return  ! autonum . releaseJump ;
  ...
  break ;  case "shoot" :  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . shoot ;
  
  if ( state == "press" )  return autonum . pressShoot ;
  
  if ( state == "release" )  return  ! autonum . releaseShoot ;
  ...
  break ;  case "spec1" :  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . spec1 ;
  
  if ( state == "press" )  return autonum . spec1 &&  ! autonum . wasSpec1 ;
  
  if ( state == "release" )  return  ! autonum . releaseSpec1 ;
  ...
  break ;  case "spec2" :  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . spec2 ;
  
  if ( state == "press" )  return autonum . pressSpec2 ;
  
  if ( state == "release" )  return  ! autonum . releaseSpec2 ;
  ...
  break ;  case "pause" :  if ( keyfunc ( config . key . pause )  &&  ( player == 1 || player == 0 )  )  return true ;
  ...
  break ;  case "swap" :  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . swap ;
  
  if ( state == "press" )  return autonum . pressSwap ;
  
  if ( state == "release" )  return  ! autonum . releaseSwap ;
  ...
  break ;  case "accept" :  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . accept ;
  
  if ( state == "press" )  return autonum . pressAccept ;
  
  if ( state == "release" )  return  ! autonum . releaseAccept ;
  ...
  break ;  case "leftPeek" :  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . leftPeek ;
  
  if ( state == "press" )  return autonum . pressLeftPeek ;
  
  if ( state == "release" )  return  ! autonum . releaseLeftPeek ;
  ...
  break ;  case "rightPeek" :  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . rightPeek ;
  
  if ( state == "press" )  return autonum . pressRightPeek ;
  
  if ( state == "release" )  return  ! autonum . releaseRightPeek ;
  ...
  break ;  case "downPeek" :  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . downPeek ;
  
  if ( state == "press" )  return autonum . pressDownPeek ;
  
  if ( state == "release" )  return  ! autonum . releaseDownPeek ;
  ...
  break ;  case "upPeek" :  if ( gvAutoCon && useauto )  { 
  if ( state == "hold" )  return autonum . upPeek ;
  
  if ( state == "press" )  return autonum . pressUpPeek ;
  
  if ( state == "release" )  return  ! autonum . releaseUpPeek ;
...
rebindKeys =  function ( newkey ) { resetDrawTarget (  )  ; 
 var done = false ;
 update (  )  ; 
 while (  ! done )  { 
 dbgOceanMoving (  )  ; 
 var keyname = "" ;
  switch ( newkey )  {  case 0 : keyname = gvLangObj [ "controls-menu" ]  [ "up-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . up = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 1 : keyname = gvLangObj [ "controls-menu" ]  [ "down-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . down = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 2 : keyname = gvLangObj [ "controls-menu" ]  [ "left-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . left = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 3 : keyname = gvLangObj [ "controls-menu" ]  [ "right-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . right = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 4 : keyname = gvLangObj [ "controls-menu" ]  [ "jump-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . jump = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 5 : keyname = gvLangObj [ "controls-menu" ]  [ "shoot-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . shoot = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 6 : keyname = gvLangObj [ "controls-menu" ]  [ "spec1-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . spec1 = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 7 : keyname = gvLangObj [ "controls-menu" ]  [ "spec2-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . spec2 = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 8 : keyname = gvLangObj [ "controls-menu" ]  [ "pause-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . pause = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 9 : keyname = gvLangObj [ "controls-menu" ]  [ "item-swap-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . swap = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 10 : keyname = gvLangObj [ "controls-menu" ]  [ "menu-accept-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . accept = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 11 : keyname = gvLangObj [ "controls-menu" ]  [ "cam-left-peek-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . leftPeek = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 12 : keyname = gvLangObj [ "controls-menu" ]  [ "cam-right-peek-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . rightPeek = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 13 : keyname = gvLangObj [ "controls-menu" ]  [ "cam-down-peek-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 config . key . downPeek = keyPressAny (  )  ; 
done = true ; 
 } 
  
  break ;  case 14 : keyname = gvLangObj [ "controls-menu" ]  [ "cam-up-peek-selection" ]  ; 
 if ( keyPressAny (  )  !=  - 1 )  { 
 ...
 break ;  }  var message = format ( gvLangObj [ "controls-menu" ]  [ "press-key-for" ]  , keyname )  ;
...
rebindGamepad =  function ( joystep , joypad = 0 ) { resetDrawTarget (  )  ; 
 var done = false ;
 update (  )  ; 
 var joy = null ;
 ...
 if ( keyPress ( k_escape )  ) done = true ; 
  ...
  var keyname = "" ;
  switch ( joystep )  {  case 4 : keyname = gvLangObj [ "controls-menu" ]  [ "jump-selection" ]  ; 
 ...
 joy . upPeek = joyPressAny ( 0 )  ; 
  ...
  break ;  default : done = true ; 
 break ;  }  var message = format ( gvLangObj [ "controls-menu" ]  [ "press-button-for" ]  , keyname )  ;
...
rebindJoyPeek =  function ( axis , player = 0 ) { resetDrawTarget (  )  ; 
 var joy = config . joy ;
  ...
  var message = format ( gvLangObj [ "controls-menu" ]  [ "peek-axis" ]  , gvLangObj [ "controls-menu" ]  [ axis == 0 ? "peek-horizontal" : "peek-vertical" ]  )  ;
  var done = false ;
 update (  )  ; 
 while (  ! done )  { 
  if ( keyPress ( k_escape )  ) done = true ; 
...
getConName =  function ( control , getkey = true , getjoy = true ) { getjoy = false ; 
 var output = "" ;
  switch ( control )  {  case "up" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . up . tostring (  )  ]  ; 
 
  if ( getjoy ) output += "(" + chint ( 30 )  + ")" ; 
 
  break ;  case "down" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . down . tostring (  )  ]  ; 
 
  if ( getjoy ) output += "(" + chint ( 31 )  + ")" ; 
 
  break ;  case "left" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . left . tostring (  )  ]  ; 
 
  if ( getjoy ) output += "(" + chint ( 17 )  + ")" ; 
 
  break ;  case "right" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . right . tostring (  )  ]  ; 
 
  if ( getjoy ) output += "(" + chint ( 16 )  + ")" ; 
 
  break ;  case "jump" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . jump . tostring (  )  ]  ; 
 
  if ( getjoy )  { 
  var map = gvLangObj [ "joy" ]  [ config [ "joymode" ]  . tolower (  )  ]  ;
  if (  ( (map[ ( config . joy . jump . tostring (  )  ) ] !== undefined) )  )  { 
 ...
 output += "???" ; 
  ...
  break ;  case "shoot" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . shoot . tostring (  )  ]  ; 
 
  if ( getjoy )  { 
  var map = gvLangObj [ "joy" ]  [ config [ "joymode" ]  . tolower (  )  ]  ;
  if (  ( (map[ ( config . joy . shoot . tostring (  )  ) ] !== undefined) )  )  { 
 ...
 output += "???" ; 
  ...
  break ;  case "spec1" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . spec1 . tostring (  )  ]  ; 
 
  if ( getjoy )  { 
  var map = gvLangObj [ "joy" ]  [ config [ "joymode" ]  . tolower (  )  ]  ;
  if (  ( (map[ ( config . joy . spec1 . tostring (  )  ) ] !== undefined) )  )  { 
 ...
 output += "???" ; 
  ...
  break ;  case "spec2" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . spec2 . tostring (  )  ]  ; 
 
  if ( getjoy )  { 
  var map = gvLangObj [ "joy" ]  [ config [ "joymode" ]  . tolower (  )  ]  ;
  if (  ( (map[ ( config . joy . spec2 . tostring (  )  ) ] !== undefined) )  )  { 
 ...
 output += "???" ; 
  ...
  break ;  case "swap" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . swap . tostring (  )  ]  ; 
 
  if ( getjoy )  { 
  var map = gvLangObj [ "joy" ]  [ config [ "joymode" ]  . tolower (  )  ]  ;
  if (  ( (map[ ( config . joy . swap . tostring (  )  ) ] !== undefined) )  )  { 
 ...
 output += "???" ; 
  ...
  break ;  case "pause" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . pause . tostring (  )  ]  ; 
 
  if ( getjoy )  { 
  var map = gvLangObj [ "joy" ]  [ config [ "joymode" ]  . tolower (  )  ]  ;
  if (  ( (map[ ( config . joy . pause . tostring (  )  ) ] !== undefined) )  )  { 
 ...
 output += "???" ; 
  ...
  break ;  case "accept" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . accept . tostring (  )  ]  ; 
 
  if ( getjoy )  { 
  var map = gvLangObj [ "joy" ]  [ config [ "joymode" ]  . tolower (  )  ]  ;
  if (  ( (map[ ( config . joy . accept . tostring (  )  ) ] !== undefined) )  )  { 
 ...
 output += "???" ; 
  ...
  break ;  case "leftPeek" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . leftPeek . tostring (  )  ]  ; 
 
  if ( getjoy )  { 
  var map = gvLangObj [ "joy" ]  [ config [ "joymode" ]  . tolower (  )  ]  ;
  if (  ( (map[ ( config . joy . leftPeek . tostring (  )  ) ] !== undefined) )  )  { 
 ...
 output += "???" ; 
  ...
  break ;  case "rightPeek" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . rightPeek . tostring (  )  ]  ; 
 
  if ( getjoy )  { 
  var map = gvLangObj [ "joy" ]  [ config [ "joymode" ]  . tolower (  )  ]  ;
  if (  ( (map[ ( config . joy . rightPeek . tostring (  )  ) ] !== undefined) )  )  { 
 ...
 output += "???" ; 
  ...
  break ;  case "downPeek" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . downPeek . tostring (  )  ]  ; 
 
  if ( getjoy )  { 
  var map = gvLangObj [ "joy" ]  [ config [ "joymode" ]  . tolower (  )  ]  ;
  if (  ( (map[ ( config . joy . downPeek . tostring (  )  ) ] !== undefined) )  )  { 
 ...
 output += "???" ; 
  ...
  break ;  case "upPeek" :  if ( getkey ) output += gvLangObj [ "key" ]  [ config . key . upPeek . tostring (  )  ]  ; 
 
  if ( getjoy )  { 
  var map = gvLangObj [ "joy" ]  [ config [ "joymode" ]  . tolower (  )  ]  ;
  if (  ( (map[ ( config . joy . upPeek . tostring (  )  ) ] !== undefined) )  )  { 
